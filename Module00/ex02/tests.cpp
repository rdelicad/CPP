...
int main( void ) {
    ...
    // Definición de tipos para simplificar el código
    ...
    // Mostrar el estado de cada cuenta
    ...
    // Mostrar información de todas las cuentas después de los depósitos
    Account::displayAccountsInfos();
    ...
    // Mostrar información de todas las cuentas después de los retiros
    Account::displayAccountsInfos();
